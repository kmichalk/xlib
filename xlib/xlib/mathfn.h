...
//	{
//	public:
//		virtual _Type operator()(_Type) const abstract override;
//		virtual expr<_Type>* copy() const abstract override;
//		virtual size_t argnum() const abstract override;
//		virtual x::result<void> setArgs(expr<_Type>* const* args, size_t size) abstract;
//	};
//
//	///////////////////////////////////////////////////////////////////////////////
//
...
//
//		template<class... _Arg>
//		func<_Type, _nArg>& setArgs(_Arg*... args)
//		{
//			std::cout << "*\n";
...
//		////////////////////////////////////////////////
//
//		virtual x::result<void> setArgs(expr<_Type>* const* args, size_t size) override
//		{
//			std::cout << "**, size_t\n";
//			if (size != _nArg) return x::result<void>::INVALID;
//
//			expandSetArgs_(x::gen_seq<_nArg>{}, args);
//			/*for (size_t i = 0; i < _nArg; ++i)
//				args_[i] = args[i];*/
//
...
//		virtual x::result<void> setArgs(expr<_Type>* const* args, size_t size) override
//		{
//			return size == 0 ? x::result<void>{} : x::result<void>::INVALID;
//		}
//
//		////////////////////////////////////////////////
//
