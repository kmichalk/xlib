...
namespace x
{
	...
	class Abstract
	{
		...
		class TypeEraser
		{
			template<typename> friend class Abstract; 
		...
		class StaticConcrete: //TODO: derive from _Type ?
			public TypeEraser
		{
		...
		template<typename _Type>
		class DynamicConcrete: //TODO: derive from _Type ?
			public TypeEraser
		{
